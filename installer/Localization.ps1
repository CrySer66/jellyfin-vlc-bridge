...
$script:JvbMessages = @{
    en = @{
        ...
        TrayRefresh = 'Refresh status'
        TrayExit = 'Quit Jellyfin VLC Bridge'
        TrayReady = 'Jellyfin VLC Bridge is running in the background.'
        Language = 'Language'
        ...
        Refresh = 'Refresh'
        Repair = 'Repair browser'
        OpenExtension = 'Open extension'
        ViewLogs = 'View logs'
        CopyDiagnostic = 'Copy a diagnostic without secrets'
        CreateSupportBundle = 'Create support package'
        SupportBundleTip = 'Creates a ZIP containing a safe diagnostic and redacted logs. Jellyfin tokens, user identifiers, server addresses and personal Windows paths are removed.'
        SupportBundleCreated = 'Support package created: {0}'
        SupportBundleDialogTitle = 'Save the support package'
        SupportBundleFilter = 'ZIP support package (*.zip)|*.zip'
        FindingConfigurationInvalid = 'The local configuration cannot be read. Reinstall the Bridge to repair it.'
        FindingConnectionMissing = 'The Jellyfin connection is missing. Reconnect with Quick Connect.'
        FindingJellyfinTimeout = 'Jellyfin did not answer in time. Check the server address and the local network.'
        FindingJellyfinRefused = 'The Jellyfin server refused the connection. Check that it is running and that the port is correct.'
        FindingJellyfinUnreachable = 'Jellyfin is unreachable. Check the server address, Wi-Fi or Ethernet connection and firewall.'
        FindingJellyfinReady = 'The connection to Jellyfin is working.'
        FindingVlcMissing = 'VLC could not be found. Install VLC or select vlc.exe in the playback settings.'
        FindingVlcReady = 'VLC is ready.'
        FindingBrowserMissing = 'The Windows browser connection is incomplete. Select Repair browser.'
        FindingExtensionInactive = 'The browser extension has not contacted the Bridge recently. Open or reload Jellyfin.'
        FindingBrowserReady = 'The extension and the Windows Bridge are communicating.'
        ...
        ServerAddressHint = 'Use the local HTTP or HTTPS address that opens Jellyfin from this computer.'
        InstallerPrivacyNote = 'Your Jellyfin token is protected locally and is never included in the installer.'
        ChangeServer = 'Change Jellyfin server'
        ChangeServerControlDescription = 'Enter the address of the new server. Your playback settings will be preserved and Jellyfin will display a new Quick Connect authorization.'
        ChangeServerReady = 'Your current connection remains active until the new server is authorized.'
        RequestQuickConnect = 'Get a code'
        ServerChanged = 'The new Jellyfin server is connected. Your playback settings were preserved.'
        ServerChangeFailed = 'Unable to connect the new Jellyfin server.'
        ...
        UninstallQuestion = 'Choose what should happen to the Jellyfin connection stored on this computer.'
        UninstallTitle = 'Uninstall Jellyfin VLC Bridge'
        UninstallKeep = 'Keep my Jellyfin connection'
        UninstallKeepDescription = 'Recommended. A future reinstall will reconnect automatically.'
        UninstallRemoveAll = 'Remove the application and all local data'
        UninstallRemoveAllDescription = 'Deletes the Jellyfin connection, token, settings and logs from this computer.'
        Cancel = 'Cancel'
    ...
    fr = @{
        ...
        TrayRefresh = "Actualiser l’état"
        TrayExit = 'Quitter Jellyfin VLC Bridge'
        TrayReady = 'Jellyfin VLC Bridge fonctionne en arrière-plan.'
        Language = 'Langue'
        ...
        Refresh = 'Actualiser'
        Repair = 'Réparer navigateur'
        OpenExtension = 'Ouvrir extension'
        ViewLogs = 'Voir les journaux'
        CopyDiagnostic = 'Copier un diagnostic sans secret'
        CreateSupportBundle = "Créer un paquet d’assistance"
        SupportBundleTip = "Crée un ZIP contenant un diagnostic sûr et des journaux expurgés. Les jetons Jellyfin, identifiants utilisateur, adresses serveur et chemins Windows personnels sont retirés."
        SupportBundleCreated = "Paquet d’assistance créé : {0}"
        SupportBundleDialogTitle = "Enregistrer le paquet d’assistance"
        SupportBundleFilter = "Paquet d’assistance ZIP (*.zip)|*.zip"
        FindingConfigurationInvalid = "La configuration locale est illisible. Réinstallez le Bridge pour la réparer."
        FindingConnectionMissing = "La connexion Jellyfin est absente. Reconnectez-vous avec Quick Connect."
        FindingJellyfinTimeout = "Jellyfin n’a pas répondu à temps. Vérifiez l’adresse du serveur et le réseau local."
        FindingJellyfinRefused = "Le serveur Jellyfin a refusé la connexion. Vérifiez qu’il est démarré et que le port est correct."
        FindingJellyfinUnreachable = "Jellyfin est inaccessible. Vérifiez l’adresse, le Wi-Fi ou Ethernet et le pare-feu."
        FindingJellyfinReady = "La connexion à Jellyfin fonctionne."
        FindingVlcMissing = "VLC est introuvable. Installez VLC ou choisissez vlc.exe dans les réglages de lecture."
        FindingVlcReady = "VLC est prêt."
        FindingBrowserMissing = "La connexion Windows du navigateur est incomplète. Cliquez sur Réparer navigateur."
        FindingExtensionInactive = "L’extension n’a pas contacté le Bridge récemment. Ouvrez ou rechargez Jellyfin."
        FindingBrowserReady = "L’extension et le Bridge Windows communiquent."
        ...
        StepAuthorize = 'Autorisation'
        StepReady = 'Prêt'
        ServerAddress = 'Adresse de votre serveur Jellyfin'
        ServerAddressHint = "Utilisez l’adresse HTTP ou HTTPS locale qui ouvre Jellyfin depuis cet ordinateur."
        InstallerPrivacyNote = "Le jeton Jellyfin est protégé localement et n’est jamais inclus dans l’installateur."
        ChangeServer = 'Changer de serveur Jellyfin'
        ChangeServerControlDescription = "Saisissez l’adresse du nouveau serveur. Vos réglages de lecture seront conservés et Jellyfin affichera une nouvelle autorisation Quick Connect."
        ChangeServerReady = "La connexion actuelle reste active tant que le nouveau serveur n’est pas autorisé."
        RequestQuickConnect = 'Obtenir un code'
        ServerChanged = 'Le nouveau serveur Jellyfin est connecté. Vos réglages de lecture ont été conservés.'
        ServerChangeFailed = 'Impossible de connecter le nouveau serveur Jellyfin.'
        ...
        UninstallQuestion = 'Choisissez ce qui doit arriver à la connexion Jellyfin enregistrée sur cet ordinateur.'
        UninstallTitle = 'Désinstaller Jellyfin VLC Bridge'
        UninstallKeep = 'Conserver ma connexion Jellyfin'
        UninstallKeepDescription = 'Recommandé. Une future réinstallation se reconnectera automatiquement.'
        UninstallRemoveAll = 'Supprimer le logiciel et toutes les données locales'
        UninstallRemoveAllDescription = 'Efface la connexion Jellyfin, le jeton, les réglages et les journaux de ce PC.'
        Cancel = 'Annuler'
