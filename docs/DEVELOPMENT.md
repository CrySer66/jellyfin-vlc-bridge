...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\tools\Build-WindowsRelease.ps1 -Version 1.15.0
```
...
```text
outputs\JellyfinVlcBridge-1.15.0-Setup.exe
outputs\JellyfinVlcBridge-1.15.0-win-x64.zip
```
